	...
	public static void loadAbilities(String filePath){
		...
		try {
			...
			while ((line = reader.readLine()) != null) {
				...
				if(temp[5].equals("SELFTARGET")) x = AreaOfEffect.SELFTARGET;
				else if(temp[5].equals("SINGLETARGET")) x = AreaOfEffect.SINGLETARGET;
				else if(temp[5].equals("TEAMTARGET")) x = AreaOfEffect.TEAMTARGET;
				else if(temp[5].equals("DIRECTIONAL")) x = AreaOfEffect.DIRECTIONAL;
				else if(temp[5].equals("SURROUND")) x = AreaOfEffect.SURROUND;
				
				if (temp[0].equals("CC")) {
					Effect effect = null;
					if(temp[7].equals("Dodge")) effect = new Dodge(Integer.parseInt(temp[8]));
					else if(temp[7].equals("Disarm")) effect = new Disarm(Integer.parseInt(temp[8]));
					else if(temp[7].equals("SpeedUp")) effect = new SpeedUp(Integer.parseInt(temp[8]));
					else if(temp[7].equals("Embrace")) effect = new Embrace(Integer.parseInt(temp[8]));
					else if(temp[7].equals("PowerUp")) effect = new PowerUp(Integer.parseInt(temp[8]));
					else if(temp[7].equals("Root")) effect = new Root(Integer.parseInt(temp[8]));
					else if(temp[7].equals("Shield")) effect = new Shield(Integer.parseInt(temp[8]));
					else if(temp[7].equals("Shock")) effect = new Shock(Integer.parseInt(temp[8]));
					else if(temp[7].equals("Silence")) effect = new Silence(Integer.parseInt(temp[8]));
					else if(temp[7].equals("Stun")) effect = new Stun(Integer.parseInt(temp[8]));
					ability = new CrowdControlAbility(temp[1], Integer.parseInt(temp[2]), Integer.parseInt(temp[4]), Integer.parseInt(temp[3]), x, Integer.parseInt(temp[6]), effect);
				}
				
				else if (temp[0].equals("DMG")) ability = new DamagingAbility(temp[1], Integer.parseInt(temp[2]), Integer.parseInt(temp[4]), Integer.parseInt(temp[3]), x, Integer.parseInt(temp[6]), Integer.parseInt(temp[7]));
				
				else if(temp[0].equals("HEL")) ability = new HealingAbility(temp[1], Integer.parseInt(temp[2]), Integer.parseInt(temp[4]), Integer.parseInt(temp[3]), x, Integer.parseInt(temp[6]), Integer.parseInt(temp[7]));
	...
	public static void loadChampions(String filePath){
		...
		try {
			...
			while((line = reader.readLine()) != null) {
				...
				String firstAbility = temp[8];
				String secondAbility = temp[9];
				String thirdAbility = temp[10];
				
				
				if(temp[0].equals("A")) champion = new AntiHero(temp[1],Integer.parseInt(temp[2]),Integer.parseInt(temp[3]),Integer.parseInt(temp[4]),Integer.parseInt(temp[5]),Integer.parseInt(temp[6]),Integer.parseInt(temp[7]));
				else if(temp[0].equals("H")) champion = new Hero(temp[1],Integer.parseInt(temp[2]),Integer.parseInt(temp[3]),Integer.parseInt(temp[4]),Integer.parseInt(temp[5]),Integer.parseInt(temp[6]),Integer.parseInt(temp[7]));
				else if(temp[0].equals("V")) champion = new Villain(temp[1],Integer.parseInt(temp[2]),Integer.parseInt(temp[3]),Integer.parseInt(temp[4]),Integer.parseInt(temp[5]),Integer.parseInt(temp[6]),Integer.parseInt(temp[7]));
				
				
				for(int i =0; i<availableAbilities.size(); i++) 
					if(firstAbility.equals(availableAbilities.get(i).getName())) {
						champion.getAbilities().add(availableAbilities.get(i));
						break;
					}
						
					
				for(int i =0; i<availableAbilities.size(); i++) 
					if(secondAbility.equals(availableAbilities.get(i).getName())) {
						champion.getAbilities().add(availableAbilities.get(i));
						break;
					}
				...
				for(int i =0; i<availableAbilities.size(); i++) 
					if(thirdAbility.equals(availableAbilities.get(i).getName())) {
						champion.getAbilities().add(availableAbilities.get(i));
						break;
					}
